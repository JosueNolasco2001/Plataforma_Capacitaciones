...
<p class="text-xl md:text-2xl font-light opacity-90 animate-subtitle-slide">
    ...
    <div class="flex justify-between mt-3 ">
      ...
      <div class="grid grid-cols-1  sm:grid-cols-3 gap-2">
        ...
        <article class="relative  flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-40 max-w-sm  ">
            ...
            <h3 class="z-10 mt-3 text-3xl font-bold text-white">Introduccion a Arduino</h3>
            <div class="z-10 gap-y-1 overflow-hidden text-sm leading-6 text-gray-300">Video 1</div>
        </article>     <article class="relative  flex flex-col justify-end overflow-hidden rounded-2xl px-8 pb-8 pt-40 max-w-sm  ">
            <img src="https://images.unsplash.com/photo-1499856871958-5b9627545d1a" alt="University of Southern California" class="absolute inset-0 h-full w-full object-cover">
            <div class="absolute inset-0 bg-gradient-to-t from-gray-900 via-gray-900/40"></div>
...
<form class="mt-10">
 ...
 <article class="p-6 text-base rounded-lg bg-[rgba(255,255,255,0.6)] dark:bg-[rgba(17,24,39,0.4)]">
    ...
    <article class="p-6 mb-3 mt-3 ml-6 lg:ml-12 text-base bg-[rgba(255,255,255,0.6)] dark:bg-[rgba(17,24,39,0.4)] rounded-lg ">
        <footer class="flex justify-between items-center mb-2">
            <div class="flex items-center">
                <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold"><img
                        class="mr-2 w-6 h-6 rounded-full"
    ...
    <article class="p-6 mb-3 text-base bg-[rgba(255,255,255,0.6)] dark:bg-[rgba(17,24,39,0.4)]">
        <footer class="flex justify-between items-center mb-2">
            <div class="flex items-center">
                <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold"><img
                        class="mr-2 w-6 h-6 rounded-full"
    ...
    <article class="p-6 text-base bg-[rgba(255,255,255,0.6)] dark:bg-[rgba(17,24,39,0.4)]">
        <footer class="flex justify-between items-center mb-2">
            <div class="flex items-center">
                <p class="inline-flex items-center mr-3 text-sm text-gray-900 dark:text-white font-semibold"><img
                        class="mr-2 w-6 h-6 rounded-full"
  ...
  <style>
    ...
    .animate-title-pop {
        animation: title-pop 0.8s cubic-bezier(0.68, -0.55, 0.27, 1.55) both;
    }
    
    .animate-subtitle-slide {
        animation: subtitle-slide 1s 0.4s ease-out both;
    }
