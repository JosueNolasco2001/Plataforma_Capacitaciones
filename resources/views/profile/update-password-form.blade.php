<x-form-section submit="updatePassword">
    ...
    <x-slot name="form" class="">
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password" value="{{ __('Nueva Contraseña') }}" class="!text-black font-medium" />
        ...
        <div class="col-span-6 sm:col-span-4">
            <x-label for="password_confirmation" value="{{ __('Confirmar Contraseña') }}" class="!text-black font-medium" />
