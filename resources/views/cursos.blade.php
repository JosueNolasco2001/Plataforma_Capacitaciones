    ...
    <div class="grid grid-cols-1 md:grid-cols-3 sm:grid-cols-2 gap-10">
        ...
        <div class="rounded overflow-hidden shadow-lg">
            ...
            <div class="px-6 py-4">
                ...
                <a href="#"
                    class="font-semibold text-white text-lg inline-block hover:text-indigo-600 transition duration-500 ease-in-out">Best
                    Salad Images ever</a>
...
<div class="dropdown relative inline-flex">
  <button id="dropdown-footer" type="button" class="dropdown-toggle btn btn-primary text-white" aria-haspopup="menu" aria-expanded="false" aria-label="Dropdown">
    Dropdown footer
