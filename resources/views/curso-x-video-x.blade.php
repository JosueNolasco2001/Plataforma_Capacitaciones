...
<form class="mt-10">
    <div class="w-full mb-4   rounded-lg  dark:bg-[rgba(17,24,39,0.4)]">
        <div class="px-4 py-2 dark:bg-[rgba(17,24,39,0.4)]">
            ...
            <textarea id="comment" rows="4" class="w-full px-0 text-sm text-gray-900 bg-white border-0 dark:bg-[rgba(17,24,39,0.4)] focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Write a comment..." required ></textarea>
        </div>
